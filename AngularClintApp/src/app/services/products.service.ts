...
export class ProductsService {
  ...
  getProducts(): Observable<ProductResponse[]> {
    return this.http.get<ProductResponse[]>(`${this.baseUrl}GetAllProducts`);
  }

  searchProducts(searchString: string): Observable<ProductResponse[]> {
    return this.http.get<ProductResponse[]>(`${this.baseUrl}GetProductsByCondition?SearchString=${searchString}`);
  }
